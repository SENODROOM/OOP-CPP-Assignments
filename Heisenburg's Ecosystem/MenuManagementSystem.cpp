...
int main()
{
    ...
    string pathsToTry[] = {
        "data.txt",
        "solution/data.txt",
        "Assignment 1/solution/data.txt",
        "Assignments/Assignment 1/solution/data.txt",
        "C:/Software Engineering/Semester 2/Object Oriented Programming/Assignments/Assignment 1/solution/data.txt"};
    for (int p = 0; p < 5; p++)
    {
